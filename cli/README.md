...
1. Make a deposit:
   ```
   cargo run -r --  deposit --private-key 0x186aab4d91978e03f84890147e0e4bc114c8188588deb2c58bd877f5911ad78c --amount 100000000 --token-type NATIVE --token-address 0x0000000000000000000000000000000000000000
   ```
